...
![](https://bass-militia-website.vercel.app/blob/master/assets/images/landing-page/Landing-page-preview-screenshot.png?raw=true)
...
- **The [Landing page](https://bass-militia-website.vercel.app/index.html)** - allows users to easily and clearly navigate to either a specific page of the website they desire via the navbar, or to one of the external website links via the footer icons.
- **Event images** - The top of the [Events page](https://bass-militia-website.vercel.app/events.html) allows users to see photos taken taken at the events, achieved with the use of a photo carousel.
- **Catalogue of past events** - The [Events page](https://bass-militia-website.vercel.app/events.html) also allows users to clearly see all of the previous events hosted, achieved by displaying each of the posters in a chronologically ordered grid layout.
- **[Label page](https://bass-militia-website.vercel.app/record_label.html) announcements** - Users can clearly see any public news and announcements relating to the label at the top of the Record Label page via the 'Announcements' section.
- **Back catalogue of releases** - On the [Record Label page](https://bass-militia-website.vercel.app/record_label.html) Users can easily view the chronological order of releases and premieres on the label by viewing the 'Digital Album Releases' and 'Premieres' sections on the record label page.
- **Direct file uploads / submissions** - Artists are able to upload their demo submissions for the record label directly through the website by visiting the [Record Label page](https://bass-militia-website.vercel.app/record_label.html) and filling in the contact form in the 'Submissions' section at the bottom.
- **Merchandise images** - On the [Merchandise page](https://bass-militia-website.vercel.app/merchandise.html) users can view photo carousels with the featured merchandise available.
- **Purchase merchandise** - Via the [Merchandise page](https://bass-militia-website.vercel.app/merchandise.html) users are able to securely purchase using the linked PayPal 'Buy Now' buttons which display sizes and are actively linked to the correct corresponding payment account.
- **Crew members [contact directory](https://bass-militia-website.vercel.app/contact.html)** - Users are able to easily view members involved in the team as well as their contact details. Users can click on these details to compose direct emails to the respectful recipients.
- **Submission and enquiry sections** - Users are able to see the correct avenue of contact in regards to track submissions, event enquiries or general enquiries etc by viewing the [Contact page](https://bass-militia-website.vercel.app/contact.html) and locating the section relating to their needs.
- **Direct contact forms** - Via the [Contact page](https://bass-militia-website.vercel.app/contact.html) any type of user is able to directly contact the brand via the website itself by filling in the contact form and allocating the correct reason for the enquiry.
...
- I tested the contact boxes as follows:
    - I went to the [Record Label page](https://bass-militia-website.vercel.app/record_label.html) and tried to submit the form without any information entered to verify the 'required' prompt appears. - *Working*
    ...
    - I went to the [Contact page](https://bass-militia-website.vercel.app/contact.html) and tried to submit the form without any information entered to verify the 'required' prompt appears. - *Working*
    - I tried to submit an incorrect email format to verify the error message appears. - *Working*
...
- I ran Audit tests within Google Developer Tools on both Mobile and Desktop to check that everything was hitting the highest scores possible. - Each section was 90-100%.
    ...
    **Please note the 'Best Practices' score is reduced on each page due to me deliberately placing low contrast text at the bottom of the page**
    ...
    ![](https://bass-militia-website.vercel.app/blob/master/assets/images/readme-images/1.JPG?raw=true)

    ![](https://bass-militia-website.vercel.app/blob/master/assets/images/readme-images/2.JPG?raw=true)

    ![](https://bass-militia-website.vercel.app/blob/master/assets/images/readme-images/3.JPG?raw=true)

    ![](https://bass-militia-website.vercel.app/blob/master/assets/images/readme-images/4.JPG?raw=true)
...
- I ran my website through [GTmetrix](https://gtmetrix.com) and it presented me with speed issues I had not been given on Google Developer Tools. 
    ...
    ![](https://bass-militia-website.vercel.app/blob/master/assets/images/readme-images/gmetrix-1.JPG?raw=true)
...
- Upon clicking the *Master Branch*, the page automatically refreshed and a ribbon appeared stating this below message detailing the successful deployment of the page.
    ```
    Your site is published at https://bass-militia-website.vercel.app/
    ```
